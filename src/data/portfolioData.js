...
// Toda tu información profesional integrada
// ============================================
...
export const personalInfo = {
  ...
  export const skills = [
    ...
    { name: 'VB / ASP', level: 85, icon: 'bi-code-square', color: 'primary' },
    { name: 'JavaScript', level: 85, icon: 'bi-braces', color: 'warning' },
    { name: 'Oracle', level: 90, icon: 'bi-database', color: 'danger' },
    { name: 'PHP', level: 75, icon: 'bi-code', color: 'info' }
  ]
